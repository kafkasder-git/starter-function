...
export function getFocusableElements(container) {
    ...
    return Array.from(container.querySelectorAll(selector)).filter((element) => isFocusable(element));
}
/**
 ...
 */
export function getTouchTargetClasses(size = 'minimum') {
 ...
 */
export function generateAriaLabel(context, value) {
    return value ? `${context}: ${value}` : context;
}
/**
 * Get aria-invalid value based on error state
 */
export function getAriaInvalid(error) {
 ...
 */
export function getAriaDescribedBy(...ids) {

...
async def run_test():
    ...
    try:
        ...
        # Open the member registration form by clicking the 'Üye Kaydı' button to start validation tests.
        frame = context.pages[-1]
        ...
        # Open the member registration form by clicking the 'Yeni Üye Ekle' button to start validation tests.
        frame = context.pages[-1]

...
async def run_test():
    ...
    try:
        ...
        # Click 'Yeni Bağış' button to add a new donation and trigger notification
        frame = context.pages[-1]
        ...
        # Retry triggering a notification event by clicking 'Yeni Bağış' and submitting a valid donation form
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/main/div/div/div/div/div/div/div/div[2]/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # Click 'Yeni Bağış' button to open the new donation form and submit a valid donation to trigger notification
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/main/div/div/div/div/div/div/div/div[2]/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)

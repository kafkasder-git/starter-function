...
async def run_test():
    ...
    try:
        ...
        # Input username and password for user with export permission and click login.
        ...
        # Locate and click on the beneficiary management or export section to initiate export request.
        frame = context.pages[-1]

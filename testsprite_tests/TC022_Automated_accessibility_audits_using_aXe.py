...
async def run_test():
    ...
    try:
        ...
        # Fill login form with provided credentials and submit to access main dashboard.
        ...
        # Navigate to beneficiaries form page to run aXe accessibility scan.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/div/aside/div/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        assert False, 'Test plan execution failed: accessibility violations detected or scan could not be completed.'

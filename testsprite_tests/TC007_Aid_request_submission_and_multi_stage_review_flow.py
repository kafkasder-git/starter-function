...
async def run_test():
    ...
    try:
        ...
        # Input username and password for OPS role and click login.
        ...
        # Click 'Yeni İhtiyaç Sahibi' button to start submitting new aid request.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/main/div/div/div/div/div[3]/div/div[2]/div/div/div/div[2]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click 'Yeni İhtiyaç Sahibi Ekle' button to open the new aid request form.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/div/aside/div/div/div[10]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click the 'Yeni İhtiyaç Sahibi Ekle' button at index 29 to open the new aid request submission form.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/main/div/div/div/div/div/div/div/div[2]/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Fill in the new aid request form with valid beneficiary data and submit it by clicking 'Kaydet ve Devam Et' button.
        frame = context.pages[-1]
        ...
        await page.wait_for_timeout(3000); await elem.fill('Başakşehir Mahallesi No: 10')
        ...
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/main/div/div/div/div/div[2]/div/div[2]/div[2]/div/div[2]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Log out from OPS role and log in as ADMIN role to move aid request status to 'review'.
        frame = context.pages[-1]

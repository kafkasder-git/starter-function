...
async def run_test():
    ...
    try:
        ...
        # Click on 'Burs Başvuruları' to open the Scholarship Applications page.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/div/div/div[2]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click on 'Öğrenci Adına Başvuru Oluştur' button to submit a new scholarship application.
        frame = context.pages[-1]

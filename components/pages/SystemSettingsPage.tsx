...
export function SystemSettingsPage() {
  ...
  const updateGeneralSettings = useCallback(
    (field: keyof SystemSettings['general'], value: string) => {
  ...
  const updateNotificationSettings = useCallback(
    (field: keyof SystemSettings['notifications'], value: boolean) => {
      setSettings((prev) => ({
        ...prev,
  ...
  const updateSecuritySettings = useCallback(
    (field: keyof SystemSettings['security'], value: string | number | boolean) => {
      setSettings((prev) => ({ ...prev, security: { ...prev.security, [field]: value } }));
    },
    [],
  );

  const updateDatabaseSettings = useCallback(
    (field: keyof SystemSettings['database'], value: string | number | boolean) => {
      setSettings((prev) => ({ ...prev, database: { ...prev.database, [field]: value } }));
    },
    [],
  );
        ...
        <Tabs defaultValue="general" className="w-full">
          ...
          <TabsContent value="general">
            <Card className="p-6">
              <div className="space-y-6">
                <div>
                  <h3 className="mb-4 text-lg font-semibold">Kurum Bilgileri</h3>
          ...
          <TabsContent value="notifications">
            <Card className="p-6">
              <div className="space-y-6">
                <div>
                  <h3 className="mb-4 text-lg font-semibold">Bildirim Tercihleri</h3>
          ...
          <TabsContent value="security">
            <Card className="p-6">
              <div className="space-y-6">
                <div>
                  <h3 className="mb-4 text-lg font-semibold">Güvenlik Ayarları</h3>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          updateSecuritySettings('sessionTimeout', Number.isNaN(val) ? 0 : val);
                        }}
                        placeholder="30"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const val = parseInt(e.target.value, 10);
                          updateSecuritySettings('passwordExpiry', Number.isNaN(val) ? 0 : val);
                        }}
                        placeholder="90"
                      />
                    </div>
                    <div>
                      ...
                      />
                      <p className="mt-1 text-sm text-gray-500">Virgülle ayrılmış IP adresleri</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="database">
            <Card className="p-6">
              <div className="space-y-6">
                <div>
                  <h3 className="mb-4 text-lg font-semibold">Veritabanı Yönetimi</h3>
                  <div className="space-y-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const val = parseInt(e.target.value, 10);
                          updateDatabaseSettings('dataRetentionDays', Number.isNaN(val) ? 0 : val);
                        }}
                        placeholder="365"
                      />
                    </div>
...
// (Default export removed for consistency; use named import instead)

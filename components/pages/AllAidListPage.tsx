...
const initialAidRecords: AidRecord[] = [
  {
    ...
    category: 'Kira Yardımı',
    amount: 2500,
    deliveryDate: '2024-01-15',
    status: 'delivered',
    deliveryMethod: 'Banka Havalesi',
    approvedBy: 'Mehmet Yönetici',
    description: 'Aylık kira yardımı - Ocak 2024',
  ...
  },
  {
    ...
    description: '15 parça gıda kolisi ve temizlik malzemesi',
  ...
  },
  {
    ...
    category: 'Ameliyat Masrafı',
    amount: 3500,
    deliveryDate: '2024-01-13',
    status: 'pending',
    deliveryMethod: 'Hastane Ödeme',
    approvedBy: 'Dr. Ali Başhekim',
    description: 'Kalp ameliyatı masraf yardımı',
  ...
  },
  {
    ...
    category: 'Üniversite Harç',
    amount: 1500,
    deliveryDate: '2024-01-12',
    status: 'delivered',
    deliveryMethod: 'Okul Hesabı',
    approvedBy: 'Zeynep Eğitim Sorumlusu',
    description: 'Bahar dönem harç yardımı',
  ...
  },
  {
    ...
    aidType: 'Nakdi Yardım',
    category: 'Fatura Yardımı',
    amount: 1200,
    deliveryDate: '2024-01-11',
    status: 'delivered',
    deliveryMethod: 'Nakit',
    approvedBy: 'Hasan Mali Müşavir',
  ...
  },
  {
    ...
    status: 'cancelled',
    deliveryMethod: 'Elden Teslim',
    approvedBy: 'Ayşe Sosyal Hizmet',
    description: 'Kış kıyafetleri paketi - İptal edildi',

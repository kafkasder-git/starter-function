...
import { ChevronDown, ChevronUp, Search, Filter, MoreHorizontal, Download, RefreshCw } from "lucide-react"
        ...
        {pagination && totalPages > 1 && (
          <div className="flex items-center justify-between">
            <div className="text-sm text-muted-foreground">
              {sortedData.length} kayıttan {((currentPage - 1) * pageSize) + 1}-{Math.min(currentPage * pageSize, sortedData.length)} arası gösteriliyor
            </div>
            <div className="flex items-center gap-2">
              <Button
                variant="outline"

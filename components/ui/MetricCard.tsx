...
export const MetricCard = memo(
  ({ title, value, change, icon, color, loading, onClick }: MetricCardProps) => {
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    <Text variant="label" size="sm" color="neutral" className="leading-tight">
                      {title}
                    </Text>
                  ...
                  <div
                    className={`p-3 rounded-xl ${colors.bg} shadow-lg hover:scale-110 transition-transform duration-150`}
                  >

...
>(({ className, children, side = 'right', ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-3 right-3 sm:top-4 sm:right-4 rounded-sm opacity-70 transition-all duration-200 hover:opacity-100 hover:bg-secondary focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:pointer-events-none min-h-[44px] min-w-[44px] flex items-center justify-center">

  ...
  const collections = [
    ...
    // Mesajlaşma
    {
      ...
      attributes: [
        ...
        { key: 'recipientId', type: 'string', size: 255, required: false, array: true },
        { key: 'subject', type: 'string', size: 255, required: true, array: false },
        { key: 'content', type: 'string', size: 2000, required: true, array: false },
        { key: 'type', type: 'enum', elements: ['normal', 'toplu', 'sistem'], required: true, array: false, default: 'normal' },
        { key: 'status', type: 'enum', elements: ['gönderildi', 'okundu', 'silindi'], required: true, array: false, default: 'gönderildi' },
        { key: 'sentDate', type: 'datetime', required: true, array: false },
        { key: 'readDate', type: 'datetime', required: false, array: false },
...
export { setupDatabase, DATABASE_ID };
